...
egrep --no-filename -v "^dataset\ssample_ID" ${assessment_dir}/results/${wf_version}/*/results_breakpoints.tsv >> ${assessment_dir}/results/${wf_version}/results_details_breakpoints.tsv
if [ $? -ne 0 ]; then
